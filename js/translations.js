...
const T = {
  ...
  "toast_booking_confirmed": { ar: "✅ تم تأكيد الحجز بنجاح", en: "✅ Booking confirmed successfully" },
  "toast_booking_cancelled": { ar: "🚫 تم إلغاء الحجز",       en: "🚫 Booking cancelled" },
  "toast_booking_deleted":   { ar: "🗑️ تم حذف الحجز",          en: "🗑️ Booking deleted" },
  "toast_error":             { ar: "❌ حدث خطأ، حاول مجددًا",  en: "❌ Something went wrong, try again" },
  "btn_confirming":          { ar: "جاري التأكيد...",           en: "Confirming..." },
  "btn_cancelling":          { ar: "جاري الإلغاء...",           en: "Cancelling..." }
};
